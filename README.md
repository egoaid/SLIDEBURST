...
シャッターを押すと録画が始まり、もう一度押すと止まります。**長さの上限はありません**（端末の空き容量しだい。録画中は経過時間と大きさが表示され、空き容量が少なくなったら自動で止めて、そこまでを保存します）。
...
**作品** — 撮ったものはこの端末の中に自動で保存されます。あとから開いて、フィルターも縦横比も何度でも変え直せます。いらないものは削除できます。どこにも送信されません。撮影前でも、シャッター横の「作品」ボタンからいつでも見返せます。
